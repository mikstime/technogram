...
import './style.sass'
import INST_LOGO from './InstagramLogo.png'

const UserIcon = ({className = '', ...props}) => (
    <svg {...props} aria-label="Profile" className={`${ className } user-icon`} fill="#262626" height="24" viewBox="0 0 48 48" width="24">
        <g>
            <path
...
const LikesIcon = ({className = '', ...props}) => (
    <svg aria-label="Activity Feed" className="likes-icon " fill="#262626" height="24" viewBox="0 0 48 48" width="24">
...
const SearchIcon = ({className = '', ...props}) => (
    <span {...props} className={`${className} search-icon`}/>
)

const SearchClearIcon = ({className = '', ...props}) => (
    <div {...props} className={`${className} search-clear-icon`}/>
)

const InstagramLogo = (props) => (
    <img alt="Instagram" className="instagram-logo" src={INST_LOGO} srcSet={`${INST_LOGO} 2x`}/>
)

const InstagramMini = (props) => (
    <svg aria-label="Instagram" className='mini-logo' fill="#262626" height="24" viewBox="0 0 48 48" width="24">
...
const CommentLikesIcon = (props) => (
    <span {...props} aria-label="Like" className="comments-likes-icon"/>
)
const CommentsCommentsIcon = (props) => (
    <span {...props} aria-label="Comment" className="comments-comments-icon"/>
)
const CommentsShareIcon = (props) => (
    <span {...props} aria-label="Comment" className="comments-share-icon"/>
)
const CommentsSaveIcon = (props) => (
    <span {...props} aria-label="Comment" className="comments-save-icon"/>
)
export {
    InstagramLogo,
    InstagramMini,
